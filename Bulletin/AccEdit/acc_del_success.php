	...
	<div id="page-wrapper">
		<div id="page">
			<div id="wide-content">
                    ...
                    $delQuery = "DELETE FROM Group35.login_info WHERE UID='$_SESSION[userID]';";
                    $sql_result = mysql_query($delQuery);
                    if (!$sql_result) {
                        echo'Invalid query: ' . mysql_error();
                    }
                ?>
            <p>Account Deleted successfully. You will be redirected to Homepage.</p>
